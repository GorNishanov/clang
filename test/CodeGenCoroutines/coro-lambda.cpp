...
// CHECK-LABEL: void @_ZZ9SyncAwaitIR14suspend_alwaysEDaOT_ENKUlvE_clEv(
//   CHECK: %[[Promise:.+]] = alloca %"struct.Task::promise_type"
//   CHECK: %[[Bitcast:.+]] = bitcast %"struct.Task::promise_type"* %[[Promise]] to i8*
//   CHECK: %[[ID:.+]] = call token @llvm.coro.id(i32 16, i8* %[[Bitcast]],
